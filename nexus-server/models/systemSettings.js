...
const SystemSettings = {
  ...
  // Settings a `manager`-role (not full instance `admin`) user may read via
  // GET /admin/system-preferences-for and write via POST /admin/system-preferences.
  // Centralized here (rather than two separately hand-maintained copies in
  // server/endpoints/admin.js) so the read and write sides can't drift apart.
