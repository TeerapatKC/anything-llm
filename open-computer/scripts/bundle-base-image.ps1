...
Write-Host "  https://cdn.nexusai.com/support/open-computer/base-images/<DATE>/$TarName"
Write-Host "  https://cdn.nexusai.com/support/open-computer/base-images/<DATE>/$ShaName"
