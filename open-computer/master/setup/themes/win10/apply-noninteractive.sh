      ...
      "bookmark_bar": {
         "children": [
            ...
            },
            {
               "name": "Star on Github",
               "type": "url",
               "url": "https://github.com/Mintplex-Labs/nexus-ai"
            },
            {
               "name": "Agent Computer Docs",
               "type": "url",
               "url": "https://docs.nexusai.com/features/agent-computers"
            }
         ],
         "name": "Bookmarks bar",
         "type": "folder"
...
sqlite3 "$FAVICON_DB" "INSERT OR REPLACE INTO favicons(id,url,icon_type) VALUES(1,'https://nexusai.com/',1);"
...
sqlite3 "$FAVICON_DB" "INSERT OR REPLACE INTO icon_mapping(id,page_url,icon_id) VALUES(3,'https://github.com/Mintplex-Labs/nexus-ai',2);"
sqlite3 "$FAVICON_DB" "INSERT OR REPLACE INTO icon_mapping(id,page_url,icon_id) VALUES(4,'https://github.com/Mintplex-Labs/nexus-ai/',2);"
sqlite3 "$FAVICON_DB" "INSERT OR REPLACE INTO icon_mapping(id,page_url,icon_id) VALUES(5,'https://docs.nexusai.com/features/agent-computers',3);"
sqlite3 "$FAVICON_DB" "INSERT OR REPLACE INTO icon_mapping(id,page_url,icon_id) VALUES(6,'https://docs.nexusai.com/features/agent-computers/',3);"
