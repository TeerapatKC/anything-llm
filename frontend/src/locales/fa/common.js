...
const TRANSLATIONS = {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "امکان استفاده از ابزارهای نامحدود و کاهش مصرف توکن تا 80 درصد برای هر پرس و جو را فراهم کنید - NexusAI به طور خودکار بهترین مهارت‌ها را برای هر پرس و جو انتخاب می‌کند.",
        "max-tools": {
          title: "ابزارهای مکس",
          description:
  ...
  api: {
    title: "کلیدهای API",
    description:
      "کلیدهای API به دارنده آن‌ها اجازه می‌دهند به صورت برنامه‌نویسی به این نمونه NexusAI دسترسی داشته و آن را مدیریت کنند.",
    ...
    modal: {
      ...
      helper:
        "پس از ایجاد، می‌توان از این کلید API برای دسترسی و پیکربندی برنامه‌نویسی‌شده این نمونه NexusAI استفاده کرد.",
      name: {
        label: "نام",
  ...
  llm: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات ارائه‌دهنده مدل زبانی و جاسازی انتخابی شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند در غیر این صورت NexusAI به درستی کار نخواهد کرد.",
  ...
  transcription: {
    ...
    "warn-start":
      "استفاده از مدل محلی Whisper روی دستگاه‌هایی با RAM یا CPU محدود می‌تواند هنگام پردازش فایل‌های رسانه‌ای باعث توقف NexusAI شود.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "جاسازی فرآیند تبدیل متن به بردارها است. این اعتبارنامه‌ها برای تبدیل فایل‌ها و درخواست‌های شما به فرمتی که NexusAI بتواند پردازش کند، ضروری هستند.",
    provider: {
  ...
  vector: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات نحوه عملکرد نمونه NexusAI شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "این پیکربندی شما برای نحوه مدیریت داده‌ها توسط ارائه‌دهندگان شخص ثالث متصل و NexusAI است.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "این فایل‌ها در پردازشگر اسناد که روی این نمونه از NexusAI در حال اجرا است، بارگذاری خواهند شد. این فایل‌ها به هیچ شخص ثالثی ارسال یا به اشتراک گذاشته نمی‌شوند.",
    },
    pinning: {
      what_pinning: "مخزن کردن اسناد چیست؟",
      pin_explained_block1:
        'هنگامی که شما یک سند را در NexusAI "فیکس" می‌کنید، محتوای کامل سند را در پنجره دستورالعمل برای مدل زبان بزرگ شما قرار می‌دهیم تا مدل بتواند به طور کامل آن را درک کند.',
      ...
      pin_explained_block3:
        "اگر به پاسخ‌های مورد نظر خود از NexusAI به طور پیش‌فرض دریافت نمی‌کنید، «پین کردن» یک راه عالی برای دریافت پاسخ‌های با کیفیت بالاتر در یک مرحله است.",
      accept: "باشه، متوجه شدم.",
    },
    watching: {
      what_watching: "تماشای یک مستند چه تاثیری دارد؟",
      watch_explained_block1:
        "هنگام مشاهده یک سند در NexusAI، محتوای سند به طور خودکار از منبع اصلی آن، در فواصل زمانی منظم، همگام‌سازی می‌شود. این کار، به‌طور خودکار محتوا را در هر فضای کاری که این فایل در آن مدیریت می‌شود، به‌روز می‌کند.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "حافظه",
        placeholder:
          'به عنوان مثال، نام کاربر "جو" است، کاربر در "NexusAI" کار می‌کند و غیره.',
        create: "ایجاد",
        save: "ذخیره",
        cancel: "لغو کردن",
      },
  ...
  customization: {
    interface: {
      ...
      description: "تنظیمات رابط کاربری خود را برای NexusAI تعیین کنید.",
    },
    branding: {
      title: "برندسازی و ارائه خدمات با برچسب سفید",
      description:
        "با استفاده از برندسازی سفارشی، نمونه‌ی NexusAI خود را با برچسب سفید (White-label) ارائه دهید.",
    },
    chat: {
      title: "چت",
      description: "تنظیم ترجیحات چت خود برای NexusAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "زبان نمایش",
        description:
          "زبان مورد نظر برای نمایش رابط کاربری NexusAI را انتخاب کنید - در صورت وجود ترجمه‌ها.",
      },
      logo: {
        title: "لوگوی برند",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "شما باید قبل از انتشار مطالب، با مرکز جامعه NexusAI احراز هویت کنید.",
  ...
  telegram: {
    title: "ربات تلگرام",
    description:
      "با اتصال نمونه NexusAI خود به تلگرام، می‌توانید از هر دستگاهی با فضاهای کاری خود گفتگو کنید.",
    setup: {
      step1: {
