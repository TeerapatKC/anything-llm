...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    "scheduled-jobs-logs": "スケジュールジョブのログ",
  ...
  chat_window: {
    ...
    pause_tts_speech_message: "TTS音声を一時停止",
    copy: "以下に翻訳を示します。",
    regenerate: "再生",
  ...
  scheduledJobs: {
    title: "スケジュールジョブ",
    description:
      "定期的に実行されるAIタスクを作成します。各ジョブはプロンプトを実行し、任意のツールを使い、結果を保存して確認できます。",
    newJob: "新しいジョブ",
    loading: "読み込み中...",
    emptyTitle: "スケジュールジョブはまだありません",
  ...
  sidebar: {
    ...
    private: "プライベート",
    "private-description": "これらのワークスペースはあなただけが表示できます。",
    "new-private-workspace": "新しいプライベートワークスペース",
    "no-private-workspaces": "プライベートワークスペースはまだありません。",
