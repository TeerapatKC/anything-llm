...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    "mobile-app": "NexusAI mobilā versija",
    "community-hub": {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          'Ievērojiet neierobežotu rīku un "cut token" izmantošanas samazinājumu līdz 80% uz katru pieprasījumu – NexusAI automātiski izvēlas piemērotākās prasmes katram pieprasījumam.',
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Iestatiet savas UI preferences NexusAI.",
    },
    branding: {
      title: "Zīmolrade un identitāte",
      description:
        "Pielāgojiet savu NexusAI instanci ar pielāgotu zīmolradi.",
    },
    chat: {
      title: "Saruna",
      description: "Iestatiet savas sarunas preferences NexusAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Izvēlieties vēlamo valodu NexusAI lietotāja saskarnei - kad pieejami tulkojumi.",
      },
      logo: {
  ...
  api: {
    title: "API atslēgas",
    description:
      "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo NexusAI instanci.",
    ...
    modal: {
      ...
      helper:
        "Pēc izveides API atslēgu var izmantot, lai programmatiski piekļūtu šai NexusAI instancei un to konfigurētu.",
      name: {
        label: "Nosaukums",
  ...
  llm: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā NexusAI nedarbosies pareizi.",
  ...
  transcription: {
    ...
    "warn-start":
      "Izmantojot lokālo whisper modeli iekārtās ar ierobežotu RAM vai CPU var apstādināt NexusAI, apstrādājot multivides failus.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru NexusAI var izmantot apstrādei.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu NexusAI instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un NexusAI apstrādā jūsu datus.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā NexusAI instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi.",
    },
    pinning: {
      what_pinning: "Kas ir dokumentu piespraušana?",
      pin_explained_block1:
        "Kad jūs <b>piespraudiet</b> dokumentu NexusAI, mēs ievietosim visu dokumenta saturu jūsu uzvednes logā, lai jūsu LLM to pilnībā saprastu.",
      pin_explained_block2:
        "Tas vislabāk darbojas ar <b>liela konteksta modeļiem</b> vai maziem failiem, kas ir kritiski tā zināšanu bāzei.",
      pin_explained_block3:
        "Ja jūs nesaņemat vēlamās atbildes no NexusAI pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      accept: "Labi, sapratu",
    },
    watching: {
      what_watching: "Ko dara dokumenta novērošana?",
      watch_explained_block1:
        "Kad jūs <b>novērojat</b> dokumentu NexusAI, mēs <i>automātiski</i> sinhronizēsim jūsu dokumenta saturu no tā sākotnējā avota regulāros intervālos. Tas automātiski atjauninās saturu katrā darba vietā, kur šis fails tiek pārvaldīts.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            'Pirms satura publicēšanas ir jāiespējo autentifikācija "NexusAI" sabiedrības centrā.',
  ...
  telegram: {
    title: "Telegram bot",
    description:
      "Iespējiet savu NexusAI instanci, lai varētu tikt savienots ar Telegram, un tāpēc varēsat runāt ar saviem darba grupām no jebkura ierīces.",
    setup: {
      step1: {
