...
const TRANSLATIONS = {
  ...
  general: {
    ...
    message: {
      ...
      heading: "Explícame",
      body: "los beneficios de NexusAI",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permite el uso ilimitado de herramientas y reduce el consumo de tokens hasta en un 80% por consulta: NexusAI selecciona automáticamente las habilidades adecuadas para cada solicitud.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description:
        "Establece tus preferencias de la interfaz de usuario para NexusAI.",
    },
    branding: {
      title: "Marca y marca blanca",
      description:
        "Personaliza tu instancia de NexusAI con tu propia marca.",
    },
    chat: {
      title: "Chat",
      description: "Establece tus preferencias de chat para NexusAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona el idioma preferido para renderizar la interfaz de usuario de NexusAI, cuando las traducciones estén disponibles.",
      },
      logo: {
  ...
  api: {
    title: "Claves de API",
    description:
      "Las claves de API permiten al titular acceder y administrar programáticamente esta instancia de NexusAI.",
    ...
    modal: {
      ...
      helper:
        "Una vez creada, la clave API se puede usar para acceder y configurar esta instancia de NexusAI mediante programación.",
      name: {
        label: "Nombre",
  ...
  llm: {
    ...
    description:
      "Estas son las credenciales y la configuración de tu proveedor preferido de chat e incrustación de LLM. Es importante que estas claves estén actualizadas y sean correctas, de lo contrario, NexusAI no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local de Whisper en máquinas con RAM o CPU limitadas puede detener NexusAI al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que NexusAI pueda usar para procesar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y la configuración de cómo funcionará tu instancia de NexusAI. Es importante que estas claves estén actualizadas y sean correctas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración sobre cómo los proveedores de terceros conectados y NexusAI manejan tus datos.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Estos archivos se subirán al procesador de documentos que se ejecuta en esta instancia de NexusAI. Estos archivos no se envían ni se comparten con terceros.",
    },
    pinning: {
      what_pinning: "¿Qué es fijar documentos?",
      pin_explained_block1:
        "Cuando <b>fijas</b> un documento en NexusAI, inyectaremos todo el contenido del documento en tu ventana de prompt para que tu LLM lo comprenda por completo.",
      ...
      pin_explained_block3:
        "Si no obtienes las respuestas que deseas de NexusAI por defecto, fijar es una excelente manera de obtener respuestas de mayor calidad con un clic.",
      accept: "Ok, entendido",
    },
    watching: {
      what_watching: "¿Qué hace observar un documento?",
      watch_explained_block1:
        "Cuando <b>observas</b> un documento en NexusAI, sincronizaremos <i>automáticamente</i> el contenido de tu documento desde su fuente original a intervalos regulares. Esto actualizará automáticamente el contenido en cada espacio de trabajo donde se gestione este archivo.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memoria",
        placeholder:
          "Por ejemplo, el nombre del usuario es Joe, el usuario trabaja en NexusAI, etc.",
        create: "Crear",
        save: "Guardar",
        cancel: "Cancelar",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Necesitas autenticarte con el Centro de la Comunidad de NexusAI antes de publicar elementos.",
  ...
  telegram: {
    ...
    description:
      "Conecte su instancia de NexusAI a Telegram para poder conversar con sus espacios de trabajo desde cualquier dispositivo.",
    setup: {
      step1: {
