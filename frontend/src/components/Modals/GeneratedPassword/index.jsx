      ...
      <DialogContent className="max-w-lg bg-theme-bg-secondary border-theme-modal-border">
        ...
        <div className="space-y-4">
          <p className="text-sm text-theme-text-secondary">
            {username ? (
              <>
                Give this password to <b className="text-white">{username}</b>.
                They will be required to set a password of their own the first
                time they log in.
              </>
            ) : (
          ...
          <div className="flex items-center gap-x-2">
            <code className="flex-1 select-all break-all rounded-lg bg-theme-bg-primary px-4 py-3 font-mono text-sm text-white">
              {password}
            </code>
            <Button
              type="button"
