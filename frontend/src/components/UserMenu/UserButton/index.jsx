        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger
              ...
              className="flex w-full items-center gap-2 rounded-lg p-1.5 text-left transition-all duration-300 hover:bg-theme-sidebar-item-hover data-[state=open]:bg-theme-sidebar-item-hover group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-0 group-data-[collapsible=icon]:justify-center"
            >
