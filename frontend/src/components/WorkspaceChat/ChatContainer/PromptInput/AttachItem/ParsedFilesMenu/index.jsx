      ...
      {contextWindowLimitExceeded && canEmbed && (
        <div className="flex flex-col gap-2 p-2 bg-theme-bg-secondary light:bg-theme-bg-primary rounded">
          ...
          <button
            ...
            className="border-none disabled:opacity-50 flex items-center justify-center gap-2 px-3 py-2 text-xs bg-primary-button hover:bg-theme-button-primary-hover text-theme-text-primary font-medium rounded transition-colors"
          >
            {isEmbedding ? (
              <>
                <Spinner size="sm" />
